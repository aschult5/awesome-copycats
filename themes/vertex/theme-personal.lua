...
theme.layout_cornerne                           = theme.icon_dir .. "/layouts/cornernew.png"
theme.layout_cornersw                           = theme.icon_dir .. "/layouts/cornersww.png"
theme.layout_cornerse                           = theme.icon_dir .. "/layouts/cornersew.png"
...
awful.util.tagnames = { "", "龜", "", "", "" }

local markup = lain.util.markup

-- Clock
--os.setlocale(os.getenv("LANG")) -- to localize the clock
local mytextclock = wibox.widget.textclock(markup("#FFFFFF", "%H:%M    %a %d %b"))
...
rspace0.forced_width = dpi(16)
rspace2.forced_width = dpi(16)
rspace3.forced_width = dpi(16)
rspace4.forced_width = dpi(16)
